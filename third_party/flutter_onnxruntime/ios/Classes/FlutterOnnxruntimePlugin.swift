...
public class FlutterOnnxruntimePlugin: NSObject, FlutterPlugin {
  ...
  private let ortQueueKey = DispatchSpecificKey<Void>()
  private lazy var ortQueue: DispatchQueue = {
    let queue = DispatchQueue(
      label: "com.readaloud.flutter_onnxruntime",
      qos: .userInitiated
    )
    queue.setSpecific(key: ortQueueKey, value: ())
    return queue
  }()
  ...
  private func cleanupResources() {
    ...
    if DispatchQueue.getSpecific(key: ortQueueKey) != nil {
      cleanup()
      return
    }

    ortQueue.sync(execute: cleanup)
  }
  ...
  public func handle(_ call: FlutterMethodCall, result: @escaping FlutterResult) {
    ...
    ortQueue.async {
      let safeResult: FlutterResult = { value in
        self.dispatchResult(result, value: value)
      }
      ...
      switch call.method {
      case "createSession":
        self.handleCreateSession(call: call, result: safeResult)
      case "getAvailableProviders":
        self.handleGetAvailableProviders(call: call, result: safeResult)
      case "runInference":
        self.handleRunInference(call: call, result: safeResult)
      case "closeSession":
        self.handleCloseSession(call: call, result: safeResult)
      case "getMetadata":
        self.handleGetMetadata(call: call, result: safeResult)
      case "getInputInfo":
        self.handleGetInputInfo(call: call, result: safeResult)
      case "getOutputInfo":
        self.handleGetOutputInfo(call: call, result: safeResult)
      case "createOrtValue":
        self.handleCreateOrtValue(call, result: safeResult)
      case "convertOrtValue":
        self.handleConvertOrtValue(call, result: safeResult)
      case "getOrtValueData":
        self.handleGetOrtValueData(call, result: safeResult)
      case "releaseOrtValue":
        self.handleReleaseOrtValue(call, result: safeResult)
      default:
